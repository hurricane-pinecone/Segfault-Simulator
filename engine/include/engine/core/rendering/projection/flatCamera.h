 ...
 * over a viewport of screenSize pixels, at the given zoom. The game resolves
 * its camera target/offset to a world centre (e.g. from a CameraComponent
 * following an entity) and calls this each frame, then hands the result to
