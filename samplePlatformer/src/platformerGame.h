 ...
 * OpenGLQuadRenderer) -- it does NOT override createQuadRenderer, so there is
 * no isometric backend involved. Each frame it builds a FlatProjection centred
 * on the player and hands it to the scene's FlatRenderSystem (camera follow).
 */
